...
public class Controller {
	...
	public void displayNumberOfTilesMadeVisible() {
		tilesMadeVisible.setText("" + game.sizeOfSetOfTilesMadeVisible() + "/" + (game.getHeight()*game.getWidth() - game.getMines()));
	}
	...
	public void createDummyBoard() {
		...
		for (int y = 0; y < game.getHeight(); y++) {
			for (int x = 0; x < game.getHeight(); x++) {
				...
				button.setMinSize((1.0 * board.getMaxHeight() / game.getHeight())-1, 1.0 * board.getMaxHeight() / game.getHeight()-1);
