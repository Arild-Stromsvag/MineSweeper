...
public class Game {
	...
	private final List<Tile> testBoard1 = new ArrayList<>(Arrays.asList(new Tile(1,4, true),  new Tile(0,0, true),  new Tile(1,2, true),  new Tile(3,1, true),  new Tile(7,4, true),  new Tile(6,1, true),  new Tile(3,9, true),  new Tile(3,8, true),  new Tile(9,1, true),  new Tile(2,6, true)));
	private final List<Tile> testBoard2 = new ArrayList<>(Arrays.asList(new Tile(1,0, true),  new Tile(7,8, true),  new Tile(4,1, true),  new Tile(3,1, true),  new Tile(9,2, true),  new Tile(11,9, true),  new Tile(0,0, true),  new Tile(2,6, true),  new Tile(0,10, true),  new Tile(3,9, true),  new Tile(8,0, true),  new Tile(4,7, true),  new Tile(7,1, true),  new Tile(0,3, true),  new Tile(11,2, true),  new Tile(5,8, true),  new Tile(3,4, true),  new Tile(10,6, true),  new Tile(9,10, true),  new Tile(5,6, true)));
	private final List<Tile> testBoard3 = new ArrayList<>(Arrays.asList(new Tile(8,8, true),  new Tile(13,7, true),  new Tile(1,2, true),  new Tile(0,9, true),  new Tile(7,9, true),  new Tile(9,1, true),  new Tile(13,1, true),  new Tile(11,3, true),  new Tile(5,9, true),  new Tile(10,4, true),  new Tile(0,8, true),  new Tile(3,11, true),  new Tile(8,12, true),  new Tile(2,0, true),  new Tile(10,9, true),  new Tile(0,12, true),  new Tile(7,10, true),  new Tile(7,1, true),  new Tile(12,5, true),  new Tile(9,7, true),  new Tile(11,1, true),  new Tile(11,13, true),  new Tile(9,4, true),  new Tile(5,7, true),  new Tile(6,4, true),  new Tile(13,13, true),  new Tile(9,0, true),  new Tile(13,0, true),  new Tile(8,9, true),  new Tile(12,8, true),  new Tile(1,12, true),  new Tile(7,12, true),  new Tile(11,5, true),  new Tile(12,0, true),  new Tile(10,12, true)));
	private final List<Tile> testBoard4 = new ArrayList<>(Arrays.asList(new Tile(5,7, true),  new Tile(4,6, true),  new Tile(14,0, true),  new Tile(3,11, true),  new Tile(11,5, true),  new Tile(12,10, true),  new Tile(15,15, true),  new Tile(8,0, true),  new Tile(1,3, true),  new Tile(5,4, true),  new Tile(14,13, true),  new Tile(13,11, true),  new Tile(12,12, true),  new Tile(12,0, true),  new Tile(5,8, true),  new Tile(5,5, true),  new Tile(10,15, true),  new Tile(7,14, true),  new Tile(15,14, true),  new Tile(10,11, true),  new Tile(5,12, true),  new Tile(9,11, true),  new Tile(4,2, true),  new Tile(14,5, true),  new Tile(10,1, true),  new Tile(14,7, true),  new Tile(10,6, true),  new Tile(9,8, true),  new Tile(11,3, true),  new Tile(3,7, true),  new Tile(8,1, true),  new Tile(8,15, true),  new Tile(8,11, true),  new Tile(3,4, true),  new Tile(1,9, true),  new Tile(3,0, true),  new Tile(7,12, true),  new Tile(3,15, true),  new Tile(8,4, true),  new Tile(14,14, true),  new Tile(9,14, true),  new Tile(1,10, true),  new Tile(10,5, true),  new Tile(2,1, true),  new Tile(13,6, true),  new Tile(12,15, true),  new Tile(6,9, true),  new Tile(1,6, true),  new Tile(15,9, true),  new Tile(4,4, true),  new Tile(12,14, true),  new Tile(4,9, true),  new Tile(4,10, true),  new Tile(15,1, true),  new Tile(0,13, true)));
			...
			for (int i = -1; i <= 1; i++) {
				for (int j = -1; j <= 1; j++) {
					if (isValidTile(y+i, x+j)) {
						...
						if (getTile(y+i, x+j).getValue() == 0 && !setOfTilesMadeVisible.contains(getTile(y+i, x+j))) {
...
//	Velger å ikke ha med set-metoder for height og width da Game-objektet kan komme 
...
//		board.setNeighborTilesToZero(board.getFirstPressedTile().getY(), board.getFirstPressedTile().getX());
//		board.layOutMines();
//		board.setTiles();
//		board.setValueOfTiles();
//		board.makeNeighborTilesVisible(board.getFirstPressedTile().getY(), board.getFirstPressedTile().getX());
