...
public class MSFileHandler implements IFileHandler{
	...
	public Path getFolderPath() {
		return Path.of(System.getProperty("user.home"), "git", "tdt4100-prosjekt-aris", "project", "src", "main" , "jada", "saves");
	}
	...
	public Game load(String fileName) throws FileNotFoundException {
		...
		while (scanner.hasNextLine()) {
			...
			for (int x = 0; x < game.getWidth(); x++) {
				...
				game.setTile2(rowNumber, x, Boolean.parseBoolean(tile[0]), Boolean.parseBoolean(tile[1]), Boolean.parseBoolean(tile[2]), Integer.parseInt(tile[3]));
			}
			rowNumber++;
		}
	...
	public static void main(String[] args) throws FileNotFoundException {
		System.out.println(Path.of(System.getProperty("user.home"), "git", "tdt4100-prosjekt-aris", "project", "src", "main" , "java", "saves"));
